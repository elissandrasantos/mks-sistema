...
import "./global.css";
import { Product } from './product-data'; // Certifique-se de importar Product aqui
    ...
    <div className="max-w-12xl mx-auto">
      <div className="container-fluid w-full">
        <NavigationMenu className='nav-mks flex justify-between p-3'>
          ...
          <Sheet> 
          <SheetTrigger className='text-black carrinho flex items-center p-2 rounded-md mr-5'>
            <Button className='bg-white text-black'>
              <FaShoppingCart className='m-1 text-black' />
